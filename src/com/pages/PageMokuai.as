package com.pages
{
	...
	public class PageMokuai extends MokuaiUI
	{
		...
		public function PageMokuai()
		{
			...
			Tween.to(box1,{alpha:1,x:x1,y:y1},600,Ease.circInOut);
			Tween.to(box2,{alpha:1,centerX:0,centerY:0},600,Ease.circInOut,null,100);
			Tween.to(box3,{alpha:1,x:x3,y:y3},600,Ease.circInOut,null,200);*/
		}
